...
zeroing_col <- "pco2cv_instrumentZero"

other <- c(oxy="sbe37o_oxy", press="sbe16pls_press", cond_col <- "sbe37o_cond")
...
remove_if_na <- c(sst_col,co2_col, lat_col, lon_col)           
...
parameters <- c(sst_col,sal_col,co2_col,other, zeroing_col)
